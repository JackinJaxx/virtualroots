...
class VGround: VNode, Decodable {
    ...
    init(name: String, ph: CGFloat, weight: CGFloat, density: CGFloat, waterAbsorption: CGFloat, waterFilter: VWater, cic: CGFloat, temperature: VTemperature = .ENVIRONMENT, image : String) {
